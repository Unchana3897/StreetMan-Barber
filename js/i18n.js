(function (window) {
    ...
    var I18N = {
        th: {
            ...
            book_page_p: "เลือกบริการ ช่าง วัน และเวลา แล้วกดยืนยัน จะได้ใบจองคิวเป็นรูปให้เซฟไว้แสดงช่าง",
            ...
            book_ok: "จองสำเร็จแล้ว เซฟรูปใบจองคิวไว้ แล้วแสดงให้ช่างเมื่อถึงร้าน",
            book_ok_wa: "เซฟรูปใบจองคิวด้านล่างได้เลย แล้วค่อยกดส่งข้อความ WhatsApp",
            slip_title: "ใบจองคิว",
            slip_when: "วันและเวลา",
            slip_show: "ยื่นใบจองคิวนี้ให้ช่างเมื่อถึงร้าน",
            slip_keep: "บันทึกรูปนี้ไว้ในเครื่อง",
            slip_save: "บันทึกรูปเพื่อแสดงช่าง",
            slip_done: "จองสำเร็จแล้ว",
            slip_new: "จองคิวอีกครั้ง",
            slip_after: "หลังกดยืนยัน จะมีใบจองคิวเป็นรูปให้เซฟไว้ แล้วนำไปแสดงช่างเมื่อถึงร้าน",
            slip_hint: "กดปุ่มด้านล่างเพื่อเซฟรูป หรือกดค้างที่รูปบนมือถือ",
            slip_cancel: "ยกเลิกคิวนี้",
            slip_cancel_code: "รหัสยกเลิก",
            slip_cancel_hint: "ยกเลิกได้เองถึง 2 ชั่วโมงก่อนถึงคิว ด้วยรหัสบนใบจองคิว",
            book_wait_title: "กรุณามาตามเวลาที่จองไว้",
            book_wait_note: "เวลาที่ท่านเลือกในการจองคิว เป็นการนัดหมายเพื่อแจ้งช่วงเวลาที่คาดว่าจะเข้ารับบริการกับทางร้าน หากท่านมาถึงก่อนหรือหลังเวลาที่จองไว้ และในขณะนั้นช่างกำลังให้บริการลูกค้าท่านอื่นอยู่ อาจจำเป็นต้องรอจนกว่าช่างจะให้บริการเสร็จสิ้น ทางร้านขอความกรุณาท่านมาตามเวลาที่จองไว้ เพื่อความสะดวกและเป็นระเบียบในการให้บริการ ขอขอบพระคุณสำหรับความเข้าใจและความร่วมมือครับ",
            slip_wait_title: "กรุณามาตามเวลาที่จองไว้",
            slip_wait_note: "เวลาที่ท่านเลือกในการจองคิว เป็นการนัดหมายเพื่อแจ้งช่วงเวลาที่คาดว่าจะเข้ารับบริการกับทางร้าน หากท่านมาถึงก่อนหรือหลังเวลาที่จองไว้ และในขณะนั้นช่างกำลังให้บริการลูกค้าท่านอื่นอยู่ อาจจำเป็นต้องรอจนกว่าช่างจะให้บริการเสร็จสิ้น ทางร้านขอความกรุณาท่านมาตามเวลาที่จองไว้ เพื่อความสะดวกและเป็นระเบียบในการให้บริการ ขอขอบพระคุณสำหรับความเข้าใจและความร่วมมือครับ",
            page_cancel: "ยกเลิกคิว",
            cancel_title: "ยกเลิกคิวด้วยรหัสใบจองคิว",
            cancel_p: "ใส่รหัสยกเลิกจากใบจองคิว ไม่ใช้ชื่อหรือเบอร์อย่างเดียว เพื่อไม่ให้คนอื่นยกเลิกคิวคุณได้",
            cancel_lookup: "ตรวจคิว",
            cancel_upload: "อัปโหลดใบจองคิว",
            cancel_upload_hint: "เลือกรูปใบจองคิว ระบบจะอ่านรหัสยกเลิกจาก QR หรือตัวอักษรบนใบจองคิว",
            cancel_reading: "กำลังอ่านใบจองคิว...",
            cancel_read_fail: "อ่านใบจองคิวไม่สำเร็จ ลองถ่ายใหม่ให้เห็น QR หรือรหัสยกเลิกชัดๆ",
            ...
            cancel_not_found: "ไม่พบคิวจากรหัสนี้ ตรวจรหัสบนใบจองคิวอีกครั้ง",
            ...
            book_barber_off: "ช่างคนนี้หยุดวันนี้ กรุณาเลือกช่างหรือวันอื่น",
        ...
        en: {
            ...
            book_page_p: "Pick a service, barber, day and time. After you confirm, save the booking confirmation image and show it to your barber.",
            ...
            book_ok: "Booked. Save the booking confirmation image and show it to your barber.",
            book_ok_wa: "Save the booking confirmation image below, then send the WhatsApp message.",
            slip_title: "Booking confirmation",
            slip_when: "Date and time",
            slip_show: "Show this confirmation to your barber",
            ...
            slip_after: "After you confirm, you will get a booking confirmation image to save and show the barber.",
            ...
            slip_cancel_hint: "You can cancel yourself until 2 hours before the slot, using the code on the confirmation.",
            book_wait_title: "Please arrive at your booked time",
            book_wait_note: "The time you choose is an appointment to let the shop know when you expect to arrive. If you come earlier or later and your barber is with another guest, you may need to wait until that service is finished. Please arrive at your booked time so we can serve everyone smoothly. Thank you for your understanding and cooperation.",
            slip_wait_title: "Please arrive at your booked time",
            slip_wait_note: "The time you choose is an appointment to let the shop know when you expect to arrive. If you come earlier or later and your barber is with another guest, you may need to wait until that service is finished. Please arrive at your booked time so we can serve everyone smoothly. Thank you for your understanding and cooperation.",
            page_cancel: "Cancel booking",
            cancel_title: "Cancel with the confirmation code",
            cancel_p: "Enter the cancel code from your confirmation. Name or phone alone is not enough, so other people cannot cancel your slot.",
            cancel_lookup: "Find booking",
            cancel_upload: "Upload confirmation",
            cancel_upload_hint: "Choose the confirmation photo. The page will read the cancel code from the QR or the text on the image.",
            cancel_reading: "Reading the confirmation...",
            cancel_read_fail: "Could not read the confirmation. Try a clearer photo of the QR or cancel code.",
            ...
            cancel_not_found: "No booking matches this code. Check the code on your confirmation.",
            ...
            book_barber_off: "This barber is off today. Please pick another barber or day.",
