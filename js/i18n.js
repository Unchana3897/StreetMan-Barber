(function (window) {
    ...
    var I18N = {
        th: {
            ...
            slip_save: "บันทึกรูปสลิป",
            slip_close: "ปิด",
            slip_hint: "มือถือ: กดค้างที่รูปเพื่อบันทึกลงเครื่องได้",
        ...
        en: {
            ...
            slip_save: "Save slip image",
            slip_close: "Close",
            slip_hint: "On a phone, press and hold the image to save it.",
